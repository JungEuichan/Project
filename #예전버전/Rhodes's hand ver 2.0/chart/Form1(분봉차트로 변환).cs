    ...
    public partial class Form1 : Form
    {
            ...
            else if (e.sRQName.Length == 6) 
            {
                ...
                if (i >= 0)
                {
                    if (long.Parse(axKHOpenAPI1.GetCommData(e.sTrCode, e.sRQName, 0, "거래량").Trim()) > 0)
                    {
                        ...
                        time = long.Parse(axKHOpenAPI1.GetCommData(e.sTrCode, e.sRQName, 0, "체결시간").Trim());
        ...
        public void Present()
        {
            ...
            if (i >= 0)
            {
                ...
                PriceLogListBox.Items.Add("거래량합산 :" + stockDB[i].거래량합산);
                PriceLogListBox.Items.Add("거래량저가 :" + stockDB[i].거래량저가라인);
                PriceLogListBox.Items.Add("todayBong test:" + stockDB[i].todayBong());
